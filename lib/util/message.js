...
/**
 * Handle message overlaying.
 *
 * @typedef {Object} OverlayOptions
 * @property {boolean} {keepCapitalization=false} Preserve capitalization of
 *     the overlay text instead of using the capitalization of this message.
 */
...
module.exports = class Message {
    ...
    clone() {
        ...
        result.positions = JSON.parse(JSON.stringify(this.positions));
        valueUpdated(result);
     ...
     * characters that are alphabetic characters. It also preserves or
     * moves capitalization.
     *
     * With keepCapitalization: false
     *
     *     this: Gruß dich!
     *     overlay: ZYXWVUTS
     *     output: Zyxw vuts!
     *
     * With keepCapitalization: true
     *
     *     this: Gruß dich!
     *     overlay: ZYXWVUTS
     *     output: ZYXW VUTS!
     *
     * If there are extra letters, they are appended to the end verbatim.
     *
     *     this: z.
     *     overlay: abC
     *     output: a.bC
     ...
     * @return {Message}
     */
    overlay(alphabet, overlay, options) {
