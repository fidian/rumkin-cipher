...
/**
 * @property {number} [groupSize=0] Can be any value from 2 to message length.
 */
...
module.exports = {
    ...
    decipher(message, alphabet) {
        ...
        for (i = 0; i < half; i += 1) {
            ...
            c = alphabet.matchCase(lettersOnly.charAt(i).getValue(), c);
    ...
    encipher(message, alphabet) {
        var char, chars, halfChar, i, lettersOnly, referenceIndex, result, square;
        ...
        function addHalfChar(index, positions) {
            ...
            if (halfChar) {
                ...
                c = alphabet.matchCase(lettersOnly.charAt(referenceIndex).getValue(), c);
