 ...
 * @property {number} [offset=0] Must be from 0 to ((rails - 1) * 2) - 1. So,
 *     rails 5, max offset is 7.
 * @property {number} [rails=5] Number of rails, greater than 0. Encryption
 *     happens with rails greater than 1.
 */
